...
public class StartupService {
    ...
    public void instantiateDB() {
        if (plRepo.count() == 0) {
            ...
            Star st1 = stRepo.save(new Star("Star 1", 1.0));
            Star st2 = stRepo.save(new Star("Star 2", 10.0));
            Star st3 = stRepo.save(new Star("Star 3", 100.0));
            Star st4 = stRepo.save(new Star("Star 4", 1000.0));
